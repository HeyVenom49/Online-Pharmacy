...
public class OrderSummaryDTO {
    ...
    public OrderSummaryDTO(Long id, Long userId, String status, Double totalAmount, Double deliveryFee,
                           Double discount, Double grandTotal, LocalDateTime orderedAt, LocalDateTime updatedAt, PaymentSummary payment) {
        this.id = id;
        this.userId = userId;
        this.status = status;
        this.totalAmount = totalAmount;
    ...
    public static class Builder {
        ...
        private PaymentSummary payment;
        public Builder payment(PaymentSummary payment) { this.payment = payment; return this; }
        public OrderSummaryDTO build() { return new OrderSummaryDTO(id, userId, status, totalAmount, deliveryFee, discount, grandTotal, orderedAt, updatedAt, payment); }
    }

...
public interface CatalogFeignClient {
    ...
    @CircuitBreaker(name = "catalogService", fallbackMethod = "releaseStockFallback")
    @Retry(name = "catalogService")
    ...
    default Boolean reserveStockFallback(Long medicineId, Integer quantity, String reservationId, Throwable t) {
        return false;
    }

    default Boolean releaseStockFallback(Long medicineId, Integer quantity, String reservationId, Throwable t) {
        return false;
    }
}

...
public class InventoryService {
    ...
    @Transactional
    public void releaseStock(Long medicineId, int quantity, String reservationId) {
        addStock(medicineId, quantity);
        log.info("Released {} units for medicineId={}, reservationId={}", quantity, medicineId, reservationId);
    }
    ...
    public void syncMedicineStock(Long medicineId) {
        ...
        log.debug("syncMedicineStock: medicineId={}, computed totalStock={}, current medicine.stock={}", 
                medicineId, totalStock, medicine.getStock());
        medicine.setStock(totalStock != null ? totalStock : 0);
        Medicine saved = medicineRepository.save(medicine);
        log.debug("syncMedicineStock: after save, medicineId={}, new stock={}", saved.getId(), saved.getStock());
    }
